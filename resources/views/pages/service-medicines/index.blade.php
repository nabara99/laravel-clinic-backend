                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ route('service-medicines.create') }}" class="btn btn-primary"><i class="fa-solid fa-circle-plus"></i> layanan</a>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($service_medicines as $index => $service)
                                            <tr>
                                                <td>{{$index + $service_medicines->firstItem()}}</td>
                                                <td>{{ $service->name }}</td>
